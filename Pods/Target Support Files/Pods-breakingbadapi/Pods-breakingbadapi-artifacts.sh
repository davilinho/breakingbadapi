...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/FirebasePerformance/Frameworks/FirebasePerformance.xcframework" "" "false" "ios-arm64_armv7/FirebasePerformance.framework" "ios-arm64_i386_x86_64-simulator/FirebasePerformance.framework"
fi
